...
if __name__ == '__main__':
    ...
    alphas = []
    eps = []
    for epdec in [0.6, 0.7, 0.8, 0.9, 1.0]:
        ...
        setting1 = Setting1(None, 0.6, 1e-3, final_T, omega, init_num_epochs=300, lr=5e-3, epoch_decay=epdec, budget=1.0, sensitivity=None)
